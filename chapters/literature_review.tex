...
The use of software in education has grown enormously over the past decade.
From AI-powered tools like ChatGPT to interactive platforms for primary school
children like Automatus \cite{automatus} or MathGarden \cite{rekentuin}, digital
tools have become a standard part of how children learn. Some researchers have
even described this growth as a kind of \textit{digital pandemic}
\cite{dancsa_digital_2023}, highlighting how fast and how broadly educational
software has spread across all levels of education. \\ \\
With this growth comes an important question: what actually makes a digital
learning tool effective? This is not always straightforward. A tool that works
well in a classroom does not necessarily work well as a research instrument, and
the other way around. Classroom tools are designed to engage and motivate
children over a long period of time. Research tools are designed to give
researchers control over experimental conditions and to collect reliable data.
These are two different sets of requirements, and most existing tools are built
with only one of them in mind. \\ \\
This chapter builds the theoretical foundation for understanding both sides of
this problem. We start by discussing what research tells us about the design of
effective digital learning environments, what features matter, what keeps
children motivated, and what supports learning. We then zoom in on metacognition,
since the experiment we use to evaluate our tool is centered around it and it
has been shown to play an important role in arithmetic learning. Finally, we
look at a selection of existing tools on both sides:1 Classroom platforms and
research software, and discuss their strengths and limitations. Together,
these sections motivate why a new kind of tool is needed, and what it should
look like.
...
\myworries{iets met adaptiviteit}
