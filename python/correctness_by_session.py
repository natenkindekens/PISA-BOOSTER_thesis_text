...
make_figure(
    ...
    title="Average Correctness per Session and per Day — No Adaptivity (Conditions A & B)",
    out_filename="correctness_by_session_no_adaptivity.png",
)

make_figure(
    csv_files=["data/group_Conditie_3.csv", "data/group_Conditie_4.csv"],
    title="Average Correctness per Session and per Day — Adaptivity (Conditions C & D)",
