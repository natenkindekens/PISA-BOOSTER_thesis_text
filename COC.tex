...
% --- Student info row ---
\noindent
\textbf{Student name:} Naten Kindekens \hfill \textbf{Student number:} R0899275 \rule{3cm}{0.4pt}
...
This form is related to my O \textbf{Bachelor’s} or \textbf{X} \textbf{Master’s thesis.}

\begin{tabularx}{\linewidth}{@{}lYlY@{}}
\textbf{Title Master’s thesis:} & RekenRangers: A configurable arithmetic learning tool designed for classroom use and educational research & \textbf{Supervisor:} & Prof.\,dr.\ Tom Schrijvers \\
\end{tabularx}

\vspace{1em}

\textbf{Daily supervisor:} Prof.\ Dr.\ Tom Schrijvers, Dr.\ Elien Bellon
...
\textbf{X} I \textbf{did use} GenAI Assistance. In this case \textbf{specify which ones}: Claude (Claude.ai, Anthropic), ChatGPT (OpenAI) and ElevenLabs.
...
\textbf{As a language assistant for reviewing or improving texts I wrote myself} & \textit{Claude and ChatGPT. Used to check text I wrote myself for typos and grammar mistakes, and to suggest improvements to sentence structure and wording so the text reads more clearly. The text content and ideas remained my own.} & This use is similar to using spelling and grammar check tools. In general, you do not have to refer to such kind of GenAI use in the text. 
...
\end{itemize} \\ \hline
\textbf{As a search engine to get information on a topic or to search for existing research on the topic} & \textit{Claude and ChatGPT. Used to get an initial overview of topics covered in the thesis. I wrote my own text based on this information and verified it against scientific sources rather than copying it.} & This use is similar to e.g. a Google search or checking Wikipedia. If you write your own text based on this information, you do not have to refer to the use of GenAI in the text. \textbf{You only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the existing research and references you have checked and used }(without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
\end{itemize} \\ \hline
\textbf{For literature search} & \textit{Claude and ChatGPT. Used to help discover potentially relevant papers. Every paper was then located and read manually; no paper or citation was used unless I had checked the original source myself.} & This use is comparable to e.g.\ a Google Scholar search. You do not have to refer to such kind of GenAI use; \textbf{you only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the literature references you have checked and used} (without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
} & \textit{Not used.} & According to Article 84 of the Regulations on Education and Examinations your text should allow to correctly and properly assess your own knowledge, understanding and skills. \textbf{Therefore, inserting blocks of text without quotes and a reference to GenAI assistance in your work is not allowed. }
...
\end{itemize} \\ \hline
\textbf{For generating visuals, video or audio} & \textit{Claude and ChatGPT were used to generate images for the RekenRangers application (the safari-themed visual content used in the tool). ElevenLabs was used to generate a speaking voice for the interactive demo of RekenRangers.} & Use of GenAI for generating visuals, audio or video is allowed except when it is prohibited by the teacher or the program of study. 
\medskip
\textbf{Be careful:}
\begin{itemize}
...
\end{itemize} \\ \hline
\textbf{Other use (specify here; this may also include a combination of types of use mentioned above):} & \textit{Claude and ChatGPT. Used for advice on the layout of the thesis presentation and poster, i.e. textual suggestions on what to place where. The actual presentation and poster were designed and produced by me.} & To make sure other use of GenAI is allowed within the course or thesis, and if so, the conditions that may apply, contact the teaching staff of the course or the supervisor of the thesis \textbf{beforehand} and explain the intended GenAI use. Also inform the programme director. 
